...
- курс [алгебры](logic.pdmi.ras.ru/~dvk/ITMO/Algebra) ([Карпов Д. В.](logic.pdmi.ras.ru/~dvk/)),
- курс [дискретной математики](logic.pdmi.ras.ru/~dvk/ITMO/DM) ([Карпов Д. В.](logic.pdmi.ras.ru/~dvk/), [Пастор А. В.](logic.pdmi.ras.ru/~pastor/)),
...
Преподаватели на продмате прежде преподавали на КТ и ИБ. 

*Базмат* — старые курсы математики, которые проходят, как правило, больше тем, чем на продмате, но более *поверхностно*. Так же есть важные темы, которые направлены на будущую профессиональную деятельность, которых нет на *продмате*. 
...
- математическая логика ([курс на stepik](https://stepik.org/course/30207) от github.com/shd),
...
Не выдержавшие обучения на ВТ часто переходят на Технологии в Дизайне (см. [3.1.](#3.1.)).
...
В 2022г. на ИВТ была в экспериментальном режиме новая физика, вроде бы она всем *понравилась*. В это время на СППО была старая физика, качество которой зависело от преподавателя: бывало душно и непонятно, а бывало непринужденно и понятно.
...
По непонятным причинам 😕 на ВТ очень мало девушек. После первого семестра большая их часть еще и переходит на Дизайн.
